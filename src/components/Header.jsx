    ...
    <div className="shadow-sm border-b sticky top-0 bg-white z-30 p-3">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <input
          type="text"
          placeholder="Search"
          className="bg-gray-50 border border-gray-200 rouded text-sm w-full py-2 px-4 max-w-[210px]"
        />
        {/* menu items */}
        {session ? (
      ...
      {isOpen && (
        <Modal
          isOpen={isOpen}
          className="max-w-lg w-[90%]  p-6 absolute top-56 left-[50%] translate-x-[-50%] bg-white border-2 shadow-md rounded-lg"
          ...
          <div className="flex flex-col justify-center items-center h-[100%]">
            {selectedFile ? (
              <img
                ...
                src={imageFileUrl}
                alt="selected image"
                className={`w-full max-h-[250px] object-cover cursor-pointer rounded-lg ${
